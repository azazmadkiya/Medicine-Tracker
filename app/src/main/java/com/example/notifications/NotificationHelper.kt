...
class NotificationHelper(private val context: Context) {
    ...
    companion object {
        const val CHANNEL_MEDICATION = "medication_reminders_channel_v4"
        const val CHANNEL_LOW_STOCK = "low_stock_alerts_channel_v4"
        const val CHANNEL_APPOINTMENT = "appointment_reminders_channel_v4"
